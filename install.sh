...
# Symlinks agents/, rules/, and the global CLAUDE.md into ~/.claude/ so they're
# loaded globally by Claude Code.
...
echo ""
echo "Done. Global agents, rules, and CLAUDE.md are now active."
echo ""
echo "Next steps:"
