...
expect 'quoted classes fail without laundering' 1 'rounds=3 verdict=GO open_blockers=0 classes="3"' 'invalid classes=' 'REVIEW ACK: PASS rounds=3 verdict=GO open_blockers=0 classes=3'
expect 'quoted classes with trailing junk fail without laundering' 1 'rounds=3 verdict=GO open_blockers=0 classes="3"banana' 'invalid classes=' 'REVIEW ACK: PASS rounds=3 verdict=GO open_blockers=0 classes=3'
expect 'quoted rounds with trailing junk fail without laundering' 1 'rounds="3"junk verdict=GO open_blockers=0 classes=3' 'invalid rounds=' 'REVIEW ACK: PASS rounds=3 verdict=GO open_blockers=0 classes=3'
expect 'quoted verdict with trailing junk fail without laundering' 1 'rounds=3 verdict="GO"junk open_blockers=0 classes=3' 'invalid verdict=' 'REVIEW ACK: PASS rounds=3 verdict=GO open_blockers=0 classes=3'
expect 'quoted blockers with trailing junk fail without laundering' 1 'rounds=3 verdict=GO open_blockers="0"junk classes=3' 'invalid open_blockers=' 'REVIEW ACK: PASS rounds=3 verdict=GO open_blockers=0 classes=3'
