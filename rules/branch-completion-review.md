...
Measured over 43 PRs on one project (AudioApp, 2026-08-17 → 08-24; 39 cleared the old size gate).
...
`docs/reference/rule-histories.md` §branch-completion-review (2026-08-06, AudioWebsite
...
| **UNVERIFIED** | A claimed red the reviewer could have executed and did not: one Codex verification attempt, then drop or bead. The fabricated BLOCKER on AudioApp PR #415 (2026-09-04) is the standing counterexample. |
