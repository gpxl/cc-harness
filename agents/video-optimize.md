...
2026-04-22 against `/Users/gerlando/Desktop/production/hero_product_intro.mp4`
...
|------|---------:|----:|-----:|-------:|------:|-------:|
| hero_product_intro.mp4 | 28.3 MB | 5.8 MB | 3.6 MB | 240 KB | −79% | −87% |
| ... |
```
...
|-----------|-------|--------|
| H.264 CRF | 28 | User-selected 2026-04-22 after visual A/B against hero_product_intro — lowest CRF where content remains visually indistinguishable from the source at browser playback sizes |
